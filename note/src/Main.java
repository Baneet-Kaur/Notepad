...
class note extends JFrame implements ActionListener{
    ...
    note(){
        ...
        //adding the options to the file
        file.add(f1);
        file.add(f2);
        file.add(f3);
        file.add(f4);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        switch(s){
            case "New":
                ...
                break;
            case "Save":
                //creating the object of jfilechooser class with staring path c
                JFileChooser j = new JFileChooser("D: ");

                //invoke savedialogbox
                int r = j.showSaveDialog(null);
                // r contains status of dialogbox 1 if clicked save
                if(r == 0){
            ...
            case "Open":
                ...
                // ri contains status of dialogbox 1 if clicked save
                if(ri == 0){
                    //declare a file object and store file location
